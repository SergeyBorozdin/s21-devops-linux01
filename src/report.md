...
== Решение ==
--------------
- с помощью **vim** открываю файл passwd
![id3](src/image/Part3p1.png)
- в файле passwd меняем имя машины **user1**
...
- Что бы помсотреть какой процесс занимает больше всего памяти воспользуемся клавишей **x**. Выделяет жирным колонку, по которой выполняется сортировка. Пемемещаться по колонке сортировки клавишами **<>**
...
- смотрим размер папки **/home - 144K**
>       du -h /home
![id82](src/image/Part12p11.png)
- смотрим размер папки **/var - 334M**
>       du -h /var
![id83](src/image/Part12p12.png)
- смотрим размер папки **/var/log - 68M**
>       du -h /var/log
